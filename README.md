...
- on Windows (cmd)
```
git clone https://github.com/JorasOliveira/kickstart.nvim.git %userprofile%\AppData\Local\nvim\ 
```

- on Windows (powershell)
```
git clone https://github.com/JorasOliveira/kickstart.nvim.git $env:USERPROFILE\AppData\Local\nvim\ 
```
